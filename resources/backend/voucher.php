      ...
      <div class="box-body">
        <div class="col-md-12 col-xs-12">
          <div class="table-responsive">
            <table id="tabeluser" class="table table-striped table-bordered" data-remote="<?= base64_encode(sha1('dataVoucher')); ?>" data-target="<?= base64_encode('tabelVoucher'); ?>">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Kode Voucher</th>
...
<style>
  ...
  #tabeluser thead tr th:nth-child(3) {
    width: 15% !important;
  }
  #tabeluser tbody tr td:nth-child(3) {
    text-align: center;
  }
...
<script type="text/javascript">
  $(function () {
    ...
    var dataTableUser = $('#tabeluser').DataTable({
      ...
      'pageLength': 100,
      columnDefs: [
        { orderable:false, targets: [1,3], searchable: false},
